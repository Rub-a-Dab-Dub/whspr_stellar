...
export class AdminAccountsController {
    ...
    @ApiResponse({
        status: 200,
        description: 'Returns all admin team accounts with role, status, and last login',
    })
    ...
    async inviteAdmin(
        ...
        return this.adminAccountService.inviteAdmin(dto.email, dto.role, actor.adminId, req);
    }
    ...
    async changeRole(
        ...
        return this.adminAccountService.changeRole(adminId, dto.role, dto.reason, actor.adminId, req);
    }
    ...
    @ApiParam({ name: 'adminId', description: 'UUID of the target admin' })
    @ApiResponse({ status: 200, description: 'Admin deactivated and sessions revoked' })
    ...
    async deactivateAdmin(
        ...
        return this.adminAccountService.deactivateAdmin(adminId, dto.reason, actor.adminId, req);
    }
    ...
    async reactivateAdmin(
        ...
        return this.adminAccountService.reactivateAdmin(adminId, actor.adminId, req);
    }
}
